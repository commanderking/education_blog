...
I first analyzed how a few commonly used digital tools approached this problem to have a point of comparison. Here are a couple examples from IXL and Khan Academy:
...
These questions can be effective for a quick check of student understanding, but do not provide much meaningful context or opportunities for multiple ways to solve the problem, which were our goals established in <a href="">part 1</a>. If we were to translate the cell tower lesson described in <a href="/cell-tower-1" target="_blank">part 1</a> to fit one of these common digital formats, it'd likely take the form of something like:
...
Luckily, the cell tower unit presented by TACIB already established a strong context by asking students to determine whether cell towers should be built near schools. Because the calculations in the unit are done to inform this decision, students can more easily connect that solving a math problem can lead to more informed decisions.
